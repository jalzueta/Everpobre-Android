...
public class EverpobreProvider extends ContentProvider {
    ...
    public static final String EVERPOBRE_PROVIDER = "com.fillingapps.everpobre.provider";

    // content://com.fillingapps.everpobre.provider/notebooks
    public static final Uri NOTEBOOKS_URI = Uri.parse("content://" + EVERPOBRE_PROVIDER + "/notebooks");

    // content://com.fillingapps.everpobre.provider/notes
    public static final Uri NOTES_URI = Uri.parse("content://" + EVERPOBRE_PROVIDER + "/notes");

    // Create the constants used to differentiate between the different URI requests.
    // TODO: cambiarlo por un enum
    ...
    // projection: son los atributos que queremos coger del registro
    @Override
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case ALL_NOTEBOOKS:
                return "vnd.android.cursor.dir/vnd.fillingapp.notebook";
            case SINGLE_NOTEBOOK:
                return "vnd.android.cursor.item/vnd.fillingapp.notebook";
            case ALL_NOTES:
                return "vnd.android.cursor.dir/vnd.fillingapp.note";
            case SINGLE_NOTE:
                return "vnd.android.cursor.item/vnd.fillingapp.note";
            default:
                throw new IllegalArgumentException("Unsupported URI: " + uri);
        }
    }

    // Recibe: content://com.fillingapps.everpobre.provider/notebooks
    // Devuelve: content://com.fillingapps.everpobre.provider/notebooks/89574

    // Recibe: content://com.fillingapps.everpobre.provider/notes
    // Devuelve: content://com.fillingapps.everpobre.provider/notes/89574
    @Override
    ...
    // Recibe: content://com.fillingapps.everpobre.provider/notebooks/89574
    @Override
    ...
    //TODO: pasar todos estos metodos a una clase EverpobreProviderHelper
